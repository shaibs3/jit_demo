namespace Jit.Concrete
{
    ...
    internal abstract class BaseLlmService : ILlm
    {
        ...
        {
            return await SendPromptToProvider(prompt);
        }
...
";
            ...
            string response = await SendPromptToProvider(prompt);
...
";
            ...
            var response = await SendPromptToProvider(prompt);
...
";
        ...
        protected string CleanDockerfileContent(string content)
        {
